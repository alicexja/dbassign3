...
//This query is to check whether the input ohipno is in database.
$query1 = "select * from patient where ohipno='".$ohip."'";
$result1=mysqli_query($connection,$query1);

//select the patient info and doctor's info that is treating him from a join statement.
